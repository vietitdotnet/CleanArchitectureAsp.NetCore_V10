...
{
    public class CreatePromotionItemValidator : AbstractValidator<CreatePromotionItemRequest>
    {
        public CreatePromotionItemValidator()
        {
            // ===== 1. OriginalPrice > 0 =====
            ...
            /*
                        ...
                        RuleFor(x => x.UnitName)
                            .NotEmpty().WithMessage("Tên đơn vị không được rỗng")
                            .MaximumLength(100);
            */

            RuleFor(x => x.ProductUnitId)
                .GreaterThan(0)
                .WithMessage("ProductUnitId không hợp lệ");
        }
